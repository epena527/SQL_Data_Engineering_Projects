/*
Looking for highest paying skills for data engineers.
- Calculating the median salary for each skill required in data engineer positions
- Focus on remote work with specified salaries
- Including skill frequency to identify which skills are in indistry demand 
    and how those skills are providing a more complete picture for skill development priorities
*/
